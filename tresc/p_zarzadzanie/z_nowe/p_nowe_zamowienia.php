...
<?php
    ...
    $wynik = mysqli_query($db_c, "SELECT * FROM sprzedaz INNER JOIN uzytkownicy ON sprzedaz.id_uzytkownika = uzytkownicy.id GROUP BY id_zamowienia HAVING potwierdzenie='nowy'");
