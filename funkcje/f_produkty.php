...
function w_produkt_kafelek($id)
{
  global $db_c;
    ...
    echo '<div class="thumbnail">'
          ...
          .'';
    $wynik = mysqli_query($db_c, $zapytanie);
...
function w_produkty_kafelki($id_kategorii, $cena_min=0, $cena_max=0, $liczba_na_strone = 0, $strona = 0)
{
  global $db_c;
    ...
    $zapytanie2 = mysqli_query ($db_c,"SELECT COUNT(*) AS liczba {$zapytanie}"); // liczmy ilość rekordów
    $wynik2 = mysqli_fetch_array($zapytanie2); // pobieramy liczbę rekordów
    ...
    $wynik = mysqli_query($db_c, "SELECT * {$zapytanie}"); // zapytanie do bazy danych
...
{
  global $db_c;
    $wynik = mysqli_query($db_c, "SELECT * FROM produkty");
...
{
  global $db_c;
    $wynik = mysqli_query($db_c, "SELECT nazwa FROM kategorie WHERE id_kategorii={$id_kategorii}");
    while($r = mysqli_fetch_assoc($wynik)) 
    {
        return $r['nazwa'];
    }
...
echo '<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <a href="index.php?v=tresc/karta_produktu/karta_produktu&id_produktu=20"><img src="img/karuzela/karuzela1.jpg" alt="Żubr"></a>
    ...
    <div class="item">
      <a href="index.php?v=tresc/karta_produktu/karta_produktu&id_produktu=15"><img src="img/karuzela/karuzela2.jpg" alt="Finlandia"></a>
      <div class="carousel-caption">
        <h3></h3>
        <p></p>
      </div>
    ...
    <div class="item">
      <a href="index.php?v=tresc/karta_produktu/karta_produktu&id_produktu=30"><img src="img/karuzela/karuzela3.jpg" alt="Flower"></a>
      <div class="carousel-caption">
        <h3></h3>
        <p></p>
      </div>
    ...
    <div class="item">
      <a href="index.php?v=tresc/karta_produktu/karta_produktu&id_produktu=36"><img src="img/karuzela/karuzela4.jpg" alt="Flower"></a>
      <div class="carousel-caption">
        <h3></h3>
        <p></p>
      </div>
